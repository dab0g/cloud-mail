const zh = {
    ...
    searchSender: '搜索发件人',
    userEmail: '用户邮箱',
    type: '类型', value: '值', email: '邮箱', spam: '垃圾邮件',
    forumRouting: 'Telegram 论坛主题与垃圾邮件路由', configure: '配置', forumSecurityInfo: 'ID 和路由仅存储在受保护的应用数据库中。Cloudflare Analytics 令牌是 Worker 密钥，不会在此处输入。', forumGroup: '论坛群组', forumChatId: '论坛群组 ID (-100...)', defaultNormalTopic: '默认普通主题 ID', defaultSpamTopic: '默认垃圾邮件主题 ID', forumEnabled: '已启用', saveForum: '保存论坛设置', sendTopicTest: '向普通主题发送测试消息', forumSaved: '论坛设置已保存', topicTestSent: '测试消息已发送', recipientRoutes: '收件人路由', recipientEmail: '收件人', normalTopic: '普通主题', spamTopic: '垃圾邮件主题', addOrUpdate: '添加 / 更新', cloudflareZones: 'Cloudflare 区域', zoneId: 'Cloudflare Zone ID', globalSpamPolicy: '全局垃圾邮件策略', spamScoring: '启用垃圾邮件评分', cloudflareSpamAlways: 'Cloudflare isSpam 始终视为垃圾邮件', finalEventOnly: '仅在 Cloudflare 最终事件后分类', ignoreEarlyNone: '忽略非最终 none 状态', threshold: '阈值', minimumSignals: '最少可疑信号数', authWeights: '认证结果权重', authPass: 'pass', authNone: 'none', authSoftfail: 'softfail', authFail: 'fail', authTemperror: 'temperror', authPermerror: 'permerror', authUnknown: 'unknown', spfSoftfail: 'SPF softfail', spfNone: 'SPF none', spfFail: 'SPF fail', dkimNone: 'DKIM none', dkimFail: 'DKIM fail', dmarcNone: 'DMARC none', dmarcFail: 'DMARC fail', saveSpamPolicy: '保存垃圾邮件策略', spamPolicySaved: '垃圾邮件策略已保存', senderOverrides: '发件人例外规则', forceSpam: '强制归为垃圾邮件', forceNormal: '强制归为普通邮件', telegramStatus: 'Telegram'
}
export default zh
