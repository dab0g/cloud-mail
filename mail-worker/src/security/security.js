...
const premKey = {
	...
	'setting:set': ['/setting/set', '/setting/setBackground','/setting/deleteBackground','/setting/setBlacklist', '/forum/config', '/forum/routes', '/forum/zones', '/forum/test', '/spam/rules'],
